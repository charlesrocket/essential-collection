...
project = 'charlesrocket.essential Ansible collection'
copyright = '-k'

title = 'charlesrocket.essential Ansible Collection Documentation'
html_short_title = 'charlesrocket.essential Documentation'
